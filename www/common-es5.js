...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppServicesDisLikeServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var LIKED_EPI = 'likedEpisodes';
    var DISLIKED_EPI = 'dislikedEpisodes';
    var LIKED_CHAR = 'likedCharacters';
    var DISLIKED_CHAR = 'dislikedCharacters';

    var LikeService = /*#__PURE__*/function () {
      function LikeService(storage, storageChar) {
      ...
      _createClass(LikeService, [{
        ...
        key: "getAllDislikedCharacters",
        value: function getAllDislikedCharacters() {
          return this.storageChar.get(DISLIKED_CHAR);
        }
      }, {
        key: "isLikedCharacter",
        value: function isLikedCharacter(characterId) {
          return this.getAllLikedCharacters().then(function (result) {
            return result && result.indexOf(characterId) !== -1;
          });
        }
      }, {
        key: "isDislikedCharacter",
        value: function isDislikedCharacter(characterId) {
          return this.getAllDislikedCharacters().then(function (result) {
            return result && result.indexOf(characterId) !== -1;
          });
        }
      }, {
        ...
        value: function likeCharacter(characterId) {
          ...
          return this.getAllLikedCharacters().then(function (result) {
            if (result) {
              ...
              return _this.storageChar.set(LIKED_CHAR, result);
            } else {
              return _this.storageChar.set(LIKED_CHAR, [characterId]);
            }
          });
        }
      }, {
        ...
        value: function dislikeCharacter(characterId) {
          ...
          return this.getAllDislikedCharacters().then(function (result) {
            if (result) {
              result.push(characterId);
              return _this2.storageChar.set(DISLIKED_CHAR, result);
            } else {
              return _this2.storageChar.set(DISLIKED_CHAR, [characterId]);
            }
          });
        }
      }, {
        key: "removeLikedCharacter",
        value: function removeLikedCharacter(characterId) {
          var _this3 = this;
          ...
          return this.getAllLikedCharacters().then(function (result) {
            if (result && result.indexOf(characterId) !== -1) {
              ...
              return _this3.storageChar.set(LIKED_CHAR, result);
            }
          });
        }
      }, {
        key: "removeDislikedCharacter",
        value: function removeDislikedCharacter(characterId) {
          var _this4 = this;
          ...
          return this.getAllDislikedCharacters().then(function (result) {
            if (result && result.indexOf(characterId) !== -1) {
              var index = result.indexOf(characterId);
              result.splice(index, 1);
              return _this4.storageChar.set(DISLIKED_CHAR, result);
            }
          });
        }
      }, {
        key: "noStatusCharacter",
        value: function noStatusCharacter(characterId) {
          this.removeDislikedCharacter(characterId);
          this.removeLikedCharacter(characterId);
        } //=============================EPISODES===============================
        ...
        key: "getAllDislikedEpisodes",
        value: function getAllDislikedEpisodes() {
          return this.storage.get(DISLIKED_EPI);
        }
      }, {
        key: "isLikedEpisode",
        value: function isLikedEpisode(episodeId) {
          return this.getAllLikedEpisodes().then(function (result) {
            return result && result.indexOf(episodeId) !== -1;
          });
        }
      }, {
        key: "isDislikedEpisode",
        value: function isDislikedEpisode(episodeId) {
          return this.getAllDislikedEpisodes().then(function (result) {
            return result && result.indexOf(episodeId) !== -1;
          });
        }
      }, {
        ...
        value: function likeEpisode(episodeId) {
          ...
          return this.getAllLikedEpisodes().then(function (result) {
            if (result) {
              ...
              return _this5.storage.set(LIKED_EPI, result);
            } else {
              return _this5.storage.set(LIKED_EPI, [episodeId]);
            }
          });
        }
      }, {
        ...
        value: function dislikeEpisode(episodeId) {
          ...
          return this.getAllDislikedEpisodes().then(function (result) {
            if (result) {
              result.push(episodeId);
              return _this6.storage.set(DISLIKED_EPI, result);
            } else {
              return _this6.storage.set(DISLIKED_EPI, [episodeId]);
            }
          });
        }
      }, {
        key: "removeLikedEpisode",
        value: function removeLikedEpisode(episodeId) {
          var _this7 = this;
          ...
          return this.getAllLikedEpisodes().then(function (result) {
            if (result && result.indexOf(episodeId) !== -1) {
              ...
              result.splice(index, 1);
              return _this7.storage.set(LIKED_EPI, result);
            }
          });
        }
      }, {
        key: "removeDislikedEpisode",
        value: function removeDislikedEpisode(episodeId) {
          var _this8 = this;
          ...
          return this.getAllDislikedEpisodes().then(function (result) {
            if (result && result.indexOf(episodeId) !== -1) {
              var index = result.indexOf(episodeId);
              result.splice(index, 1);
              return _this8.storage.set(DISLIKED_EPI, result);
            }
          });
        }
      }, {
        key: "noStatusEpisode",
        value: function noStatusEpisode(episodeId) {
          this.removeDislikedEpisode(episodeId);
          this.removeLikedEpisode(episodeId);
        }
      }]);
    ...
    LikeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"], _ionic_storage__WEBPACK_IMPORTED_MODULE_2__["Storage"]])], LikeService);
    /***/
  },
