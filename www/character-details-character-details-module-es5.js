...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["character-details-character-details-module"], {
  ...
  function srcAppPagesCharacterDetailsCharacterDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharacterDetailsPage = /*#__PURE__*/function () {
      ...
      _createClass(CharacterDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.likeService.isLikedCharacter(this.characterId).then(function (liked) {
            _this.isLiked = liked;
          });
          this.likeService.isDislikedCharacter(this.characterId).then(function (disliked) {
        ...
        value: function likeCharacter() {
          ...
          this.likeService.likeCharacter(this.characterId).then(function () {
            _this2.isLiked = true;
        ...
        value: function dislikeCharacter() {
          ...
          this.likeService.dislikeCharacter(this.characterId).then(function () {
        ...
        value: function noStatusCharacter() {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"], _services_dis_like_service__WEBPACK_IMPORTED_MODULE_1__["LikeService"]])], CharacterDetailsPage);
    /***/
  }
}]);
